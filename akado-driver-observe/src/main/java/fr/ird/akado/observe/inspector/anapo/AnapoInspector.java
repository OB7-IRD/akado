...
public class AnapoInspector extends ObserveAnapoActivityInspector {
    ...
    public Results execute() {
        ...
        if (positions.isEmpty()) {
            ...
            AnapoResult r = createResult(MessageDescriptions.I1421_ACTIVITY_NO_TRACE_VMS, anapo,
                                         activity.getID());
            return Results.of(r);
        }
        ...
        if (positions.size() < NB_POSITIONS_VMS_MIN) {
            ...
            AnapoResult r = createResult(MessageDescriptions.I1424_INCONSISTENCY_VMS_POSITION_COUNT, anapo,
                                         activity.getID(),
        ...
        if (!m.isEmpty()) {
            ...
            AnapoResult r = createResult(MessageDescriptions.W1423_ACTIVITY_TRACE_VMS_CL2, anapo,
                                         activity.getID(),
        ...
        AnapoResult r = createResult(MessageDescriptions.E1427_ACTIVITY_TRACE_VMS_NO_MATCH, anapo,
                                     activity.getID());
        results.add(r);
        return results;
    }
