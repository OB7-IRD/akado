 ...
 * @since 1.0.0
 */
public class GearCharacteristicTypeDao extends AbstractI18nReferentialDao<GearCharacteristicType> {

    private static final String QUERY = I18N_REFERENTIAL_ENTITY_QUERY + "\n" +
            " FROM common.GearCharacteristicType";

    public GearCharacteristicTypeDao() {
        super(GearCharacteristicType.class, QUERY, GearCharacteristicType::new);
    }
}
