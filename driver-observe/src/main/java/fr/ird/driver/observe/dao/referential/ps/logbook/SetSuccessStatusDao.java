 ...
 * @since 1.0.0
 */
public class SetSuccessStatusDao extends AbstractI18nReferentialDao<SetSuccessStatus> {

    private static final String QUERY = I18N_REFERENTIAL_ENTITY_QUERY + "\n" +
            " FROM ps_logbook.SetSuccessStatus";

    public SetSuccessStatusDao() {
        super(SetSuccessStatus.class, QUERY, SetSuccessStatus::new);
    }
}
