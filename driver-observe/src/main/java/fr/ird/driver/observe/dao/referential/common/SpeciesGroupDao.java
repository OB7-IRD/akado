...
public class SpeciesGroupDao extends AbstractI18nReferentialDao<SpeciesGroup> {
    ...
    @Override
    protected void fill(SpeciesGroup result, ResultSet rs) throws SQLException, ObserveDriverException {
        super.fill(result, rs);
        result.setSpeciesGroupReleaseMode(lazyReferentialSet(result.getTopiaId(), "common", "speciesGroup_speciesGroupReleaseMode", "speciesGroup", "speciesGroupReleaseMode", SpeciesGroupReleaseMode.class));
    }
}
