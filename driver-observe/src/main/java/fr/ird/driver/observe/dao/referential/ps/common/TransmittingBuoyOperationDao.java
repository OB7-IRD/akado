 ...
 * @since 1.0.0
 */
public class TransmittingBuoyOperationDao extends AbstractI18nReferentialDao<TransmittingBuoyOperation> {

    private static final String QUERY = I18N_REFERENTIAL_ENTITY_QUERY + "\n" +
            " FROM ps_common.TransmittingBuoyOperation";

    public TransmittingBuoyOperationDao() {
        super(TransmittingBuoyOperation.class, QUERY, TransmittingBuoyOperation::new);
    }
}
