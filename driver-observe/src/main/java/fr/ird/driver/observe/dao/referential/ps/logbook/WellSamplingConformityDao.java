 ...
 * @since 1.0.0
 */
public class WellSamplingConformityDao extends AbstractI18nReferentialDao<WellSamplingConformity> {

    private static final String QUERY = I18N_REFERENTIAL_ENTITY_QUERY + "\n" +
            " FROM ps_logbook.WellSamplingConformity";

    public WellSamplingConformityDao() {
        super(WellSamplingConformity.class, QUERY, WellSamplingConformity::new);
    }
}
