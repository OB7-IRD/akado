 ...
 */
public class VMSCountryVesselTrackedDialog extends JDialog
     ...
     * @return
     */
    public String getVMSCountryVesselTracked() {
        return country;
    }
     ...
     */
    public VMSCountryVesselTrackedDialog(Frame aFrame, String msg, String currentCountry) {
        super(aFrame, true);
        ...
        // Class one
        String labelTxt = UIManager.getString("ui.swing.vms.country", new Locale(AAProperties.L10N));
        mainPanel.add(new JLabel(labelTxt), createGbc(0, 0));
        textFieldC1 = new JTextField(COLS);
        textFieldC1.setText(country);
        ...
        if (isVisible()
            ...
            if (btnString1.equals(value)) {
                ...
                if (Pattern.matches(fpRegex, typedTextC1)) {
                    ...
                    country = typedTextC1;// Will not throw NumberFormatException
                    ...
                    JOptionPane.showMessageDialog(VMSCountryVesselTrackedDialog.this,
                            "Sorry, \"" + typedTextC1 + "\" "
