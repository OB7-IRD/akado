...
/**
 * Spécifie les méthodes d'export vers un tableur, au format XLS.
 *
...
public interface XLSExport {
    ...
    /**
     * Export des résultats au format XLS. Les implémentations de la classe
     * prennent en charge le formatage du classeur. Fonction actuellement prévue
