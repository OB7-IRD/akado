...
public class ReflectionsUtils {
    ...
    public static ArrayList loadClassesFromPackage(String pckgname) {

        ArrayList instanceOfClasses = new ArrayList<>();
        try {
            for (Class<?> clazz : ReflectionsUtils.getClassesForPackage(pckgname)) {
                Constructor<?> ctor = clazz.getConstructor();
                instanceOfClasses.add((Inspector) ctor.newInstance());
            }
