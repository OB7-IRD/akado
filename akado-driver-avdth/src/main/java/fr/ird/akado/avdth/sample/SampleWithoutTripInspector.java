...
import static fr.ird.akado.avdth.Constant.CODE_SAMPLE_NO_TRIP;
import static fr.ird.akado.avdth.Constant.LABEL_SAMPLE_NO_TRIP;
 ...
 *
 */
public class SampleWithoutTripInspector extends Inspector<Sample> {

    public SampleWithoutTripInspector() {
        super();
        this.name = this.getClass().getName();
        this.description = "Check if the sample is linked at one trip.";
    }
    ...
    public Results execute() {
        ...
        if (!TripDAO.exist(trip)) {
            ...
            r.setMessageCode(CODE_SAMPLE_NO_TRIP);
            r.setMessageLabel(LABEL_SAMPLE_NO_TRIP);
