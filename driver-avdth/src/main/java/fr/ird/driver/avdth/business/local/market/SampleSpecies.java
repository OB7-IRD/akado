...
/**
 * This class name in AVDTH is FP_ECH_ESP.
...
public class SampleSpecies {
    ...
    public String toString() {
        return "SampleSpecies{" + "vessel=" + vessel + ", landingDate=" + landingDate + ", sampleNumber=" + sampleNumber + ", species=" + species + ", measuredCount=" + measuredCount + ", ldlf=" + ldlf + ", sampleSpeciesFrequencys=" + sampleSpeciesFrequencys + '}';
    }
